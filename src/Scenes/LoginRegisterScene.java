...
public class LoginRegisterScene implements ControllableScene {
    ...
    public Scene getScene() {
        ...
        Text labelName = textLabel("Nombre:");
        TextField name = textBox();
        Text labelAge = textLabel("Edad:");
        TextField age = textBox();

        labels.add(labelUser, 0, 0);
        labels.add(username, 1, 0);
        labels.add(labelPass, 0, 1);
        labels.add(password, 1, 1);
        labels.add(labelName, 0, 2);
        labels.add(name, 1, 2);
        labels.add(labelAge, 0, 3);
        labels.add(age, 1, 3);
        ...
        Button crear = crearUser(username, password, name, age);
